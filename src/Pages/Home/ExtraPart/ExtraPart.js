...
const ExtraPart = () => {
    return (
        <div style={{ height: '220px' }} className='row'>
            <div className='col-4 bg-success d-flex justify-content-between'>
            ...
            <div className='col-4 bg-primary d-flex justify-content-between'>
            ...
            <div className='col-4 bg-info d-flex justify-content-between'>
                <div className='d-flex w-75 h-100 justify-content-center align-items-center'>
